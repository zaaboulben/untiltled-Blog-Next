...
export default function LatestBlog() {
    ...
    return (
        <section className="w-full flex flex-col justify-start items-start gap-10 ">
            ...
            <div className="inline-flex  justify-between pt-20 w-full " >
                ...
                <div className="flex flex-col gap-6"  >
                    ...
                    <div className="inline-flex  justify-between w-[80vw] ">
                    <h2 className="text-gray-900 text-4xl font-semibold leading-10 whitespace-nowrap " >Latest blog posts</h2>
                        <div className="  xl:flex hidden justify-end items-start  " >
            ...
            <div className="w-screen  xl:hidden inline-flex justify-center items-start  " >
                <button className="rounded-lg px-5 py-3  bg-violet-500 shadow border border-violet-500 justify-center text-white ">View all posts</button>
            </div>
